...
@tbl-one reveals several critical insights about border quarantine during the Delta wave. The data demonstrates an exponential relationship between vaccine efficacy and outbreak protection. While 50% efficacy vaccines provided only modest improvements (extending outbreak timelines from 15 to 22-35 days), 90% efficacy vaccines created dramatic protection, extending the timeframe to 1,000-2,000 days at full population coverage.

The most striking finding is the threshold effect observed with high-efficacy vaccines. At 90% efficacy, each increase in population coverage produces disproportionately larger gains in protection. For R₀ = 6, moving from 20% to 100% coverage extends the outbreak timeline from 450 to 2,000 days, a more than fourfold increase.

The analysis also highlights that vaccination within quarantine systems alone was insufficient - high community vaccination rates were equally important. As noted in the research, "border quarantine systems cannot be used to compensate for low levels of community vaccination" [Zachreson et al. (2022)]. This finding had significant policy implications, suggesting that reopening borders safely required a dual approach: vaccinating both travelers and the general population.
...
1. Vaccine efficacy thresholds are critical: Low-efficacy vaccines (50%) provided minimal protection, while high-efficacy vaccines (90%) could extend outbreak protection by two orders of magnitude.
