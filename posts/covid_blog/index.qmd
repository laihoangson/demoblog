...
@tbl-one reveals several critical insights about border quarantine during the Delta wave. The data demonstrates a striking exponential relationship between vaccine efficacy and outbreak protection. While 50% efficacy vaccines provided only modest improvements (extending outbreak timelines from the baseline of 15 days to 22-35 days), 90% efficacy vaccines created extraordinary protection, extending the timeframe to 2,000-3,000 days at full population coverage - representing an improvement of nearly two orders of magnitude.
